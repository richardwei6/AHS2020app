        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot child_sn: snapshot.getChildren()) {
                    ...
                    final String articleID = child_sn.child(r.getString(R.string.fb_notif_artID)).getValue(String.class);
                    String body = child_sn.child(r.getString(R.string.fb_notif_body)).getValue(String.class);
                    String title = child_sn.child(r.getString(R.string.fb_notif_title)).getValue(String.class);
                    long time = (long) child_sn.child(r.getString(R.string.fb_notif_time)).getValue();
                    Integer category_holder = child_sn.child(r.getString(R.string.fb_notif_cat)).getValue(int.class);
                    int category = (category_holder != null) ? category_holder : -1;
